...
//    private final String SEARCH_RESULT_PAGE = "search.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(MVC2ProjectConstants.LoginFeatures.SEARCH_PAGE);
...
//                url = SEARCH_RESULT_PAGE;
            ...
            log("SearchLastnameServlet _ Naming " + e.getMessage());
        } catch (SQLException e) {
            log("SearchLastnameServlet _ SQL " + e.getMessage());
